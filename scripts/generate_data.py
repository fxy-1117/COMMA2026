...
- `combined_arggraph_dataset.csv` from the XML files under `corpus/`;
- `neu2.csv` neutral pairs from the combined dataset.
...
def build_parser() -> argparse.ArgumentParser:
    ...
    arggraph = subparsers.add_parser("arggraph", help="generate combined_arggraph_dataset.csv")
    arggraph.add_argument("--input", type=Path, default=Path("corpus"))
    arggraph.add_argument("--output", type=Path, default=Path("combined_arggraph_dataset.csv"))
    arggraph.add_argument("--separate-dir", type=Path, default=None)
    arggraph.set_defaults(func=generate_arggraph_dataset)

    neutral = subparsers.add_parser("neutral", help="generate neu2.csv using an NLI model")
    neutral.add_argument("--input", type=Path, default=Path("combined_arggraph_dataset.csv"))
    neutral.add_argument("--output", type=Path, default=Path("neu2.csv"))
